-- 028_remove_legacy_notoriety_from_actions.sql
-- Retire l'écriture dans notoriety_points (ancienne gloire) de discover_place, claim_place, fortify_place.
-- La vraie gloire V0.5 = exploration_points + erudition_points (déjà gérés).

-- ============================================================
-- 1. discover_place — supprime notoriety_points, garde exploration_points
-- ============================================================
...
BEGIN
  ...
  -- Exploration points (la gloire V0.5 = exploration + érudition)
...
-- ============================================================
-- 2. claim_place — supprime notoriety_points
-- ============================================================
...
BEGIN
  ...
  RETURN json_build_object('success', true, 'energy', v_energy, 'claimCost', v_claim_cost,
    'factionId', v_faction_id, 'free', p_free);
END;
$$;
...
-- ============================================================
-- 3. fortify_place — supprime notoriety_points
-- ============================================================
...
BEGIN
  ...
  UPDATE users SET energy_points = energy_points - v_cost WHERE id = p_user_id;
  ...
  RETURN json_build_object('success', true, 'energy', v_energy,
