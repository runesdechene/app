...
export class GetMapBannersQuery extends BaseCommand<Payload> {
...
@QueryHandler(GetMapBannersQuery)
export class GetMapBannersQueryHandler
  implements IQueryHandler<GetMapBannersQuery, ApiPlaceMap[]>
{
  constructor(private readonly em: EntityManager) {}

  async execute(query: GetMapBannersQuery): Promise<ApiPlaceMap[]> {
