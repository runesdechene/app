-- 317_faction_detail_member_gender.sql
-- WHY : exposer `titleGender` par membre dans get_faction_detail, pour accorder le badge
-- « Fondateur historique » → « Fondatrice historique » au féminin. Corps = mig 312 + 1 clé. ADDITIF.
