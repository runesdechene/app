-- 033_titles_zero_glory_and_content_influence.sql
-- 1. get_user_titles : gloire 0 = aucun titre débloqué
-- 2. get_faction_members : ajouter influence pérenne (content) par membre

-- ============================================================
-- 1. get_user_titles — gloire 0 = pas de titres
-- ============================================================
...
BEGIN
  ...
  -- Gloire 0 = aucun titre débloqué (sauf titres sans condition)
  IF v_glory = 0 THEN
    RETURN json_build_object(
      'unlockedGeneralTitles', '[]'::json,
...
-- ============================================================
-- 2. get_faction_members — ajouter influence pérenne par membre
-- ============================================================
