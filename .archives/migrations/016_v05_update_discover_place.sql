-- 016_v05_update_discover_place.sql
-- V0.5 : Mettre à jour discover_place pour ajouter exploration_points, influence_stock,
--         place_explorers insert, place_influence insert, et nouveaux champs JSON retour.
-- Basé sur la version actuelle (migration 175).
...
BEGIN
  ...
  -- Gloire (legacy notoriety_points)
  ...
  -- V0.5 : le créateur/découvreur est automatiquement explorateur
