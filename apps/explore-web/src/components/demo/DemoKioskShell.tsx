        ...
        <div className="demo-welcome" onClick={() => setShowWelcome(false)}>
          <div className="demo-welcome-card" onClick={(e) => e.stopPropagation()}>
            <span
              ...
              aria-hidden="true"
            />
            <h2 className="demo-welcome-title">Bienvenue sur <span>La Carte</span></h2>
            <p className="demo-welcome-sub">Des milliers de lieux anciens, magiques ou atypiques, ajoutés et veillés par les <b>Porteurs de Fragments</b>.</p>
            <ul className="demo-welcome-steps">
              ...
              <li>
                ...
                <b>Résolvez des énigmes</b>
              </li>
            </ul>
            <button className="demo-welcome-cta" onClick={() => setShowWelcome(false)}>Entrer sur la Carte</button>
          </div>
        </div>
      )}
      {showIntro && (
          ...
          <div className="demo-intro-content">
            <div className="demo-intro-head">
              ...
              <h1 className="demo-intro-title">
                ...
                <span className="demo-title-gold">Maintenant, explorez-la.</span>
              </h1>
              <p className="demo-intro-tagline">
                La Carte des lieux anciens, magiques ou atypiques de nos contrées - trouvés, racontés et veillés par les <span className="demo-tag-num">Porteurs de Fragments</span>.
              </p>
            </div>
            <div className="demo-intro-cta-group">
              ...
              <button className="demo-intro-cta" onClick={enter}>Touchez l'écran pour explorer</button>
