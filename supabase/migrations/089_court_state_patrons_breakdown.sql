-- 089_court_state_patrons_breakdown.sql
-- WHY : sur la fiche de lieu, on doit voir si un mécène a contribué au
-- camp Soutien (défense) ou Influence (attaque). On expose donc dans
-- topPatrons un breakdown { defenseTotal, attackTotal } en plus du total.
-- Verbatim mig 088 + agg détaillée par side dans la sous-query top patrons.
...
BEGIN
  ...
  -- V089 : top patrons avec breakdown defense / attack
