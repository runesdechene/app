...
- [2026-04] **Récompenses GPS modulées** (à implémenter) : multiplicateur densité (lieux < 2km) + bonus accessibilité. Design validé, détail dans `.wolf/cerebrum-density-rewards.md`.
