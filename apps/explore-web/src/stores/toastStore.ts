...
export interface GameToast {
  id: string
  type: 'claim' | 'discover' | 'explore' | 'new_place' | 'new_user' | 'like' | 'fortify' | 'contribute' | 'revisit' | 'enigma' | 'influence' | 'info' | 'error' | 'plant_flag' | 'harvest_crown' | 'quest_completed' | 'court' | 'faction_join'
  message: string
  color?: string
