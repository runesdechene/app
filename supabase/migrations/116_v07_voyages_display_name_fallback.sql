-- 116_v07_voyages_display_name_fallback.sql
-- WHY : les RPCs voyages lisaient u.display_name (souvent NULL) au lieu
-- de u.first_name (le vrai nom utilisé partout dans l'app). Patch des
-- RPCs lecture pour COALESCE(display_name, first_name, 'Voyageur').
