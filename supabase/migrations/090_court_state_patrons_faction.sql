-- 090_court_state_patrons_faction.sql
-- WHY : afficher l'icône de faction de chaque mécène à côté de son nom
-- (cohérent avec l'identité Harry Potter : la faction est un trait d'identité).
-- On expose factionId / factionColor / factionPattern dans chaque entrée
-- de topPatrons. Verbatim mig 089 + jointure factions sur le user.
...
BEGIN
  ...
  -- V090 : top patrons + faction de chacun (icône faction sur la ligne)
