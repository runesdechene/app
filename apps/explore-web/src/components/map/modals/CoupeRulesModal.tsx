...
export function CoupeRulesModal({ onClose, onOpenScores }: Props) {
  ...
  return (
    <InfoModal
      icon={'🏆'}
      title={'Coupe des Compagnies'}
      description={'Chaque saison, les Compagnies s\'affrontent dans une compétition saine d\'actions personnelles. Tes plantages, tes visites, tes énigmes résolues — tout compte pour ta Compagnie. La Compagnie qui cumule le plus de points à la clôture remporte la Coupe. Même formule que la Gloire à vie, sur la fenêtre de la saison.'}
      rows={[
