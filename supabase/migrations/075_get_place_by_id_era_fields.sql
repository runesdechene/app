-- Migration 075: Add era fields to get_place_by_id return + RLS for era updates
-- Ajoute eraId, eraName, yearExact au JSON retourné par get_place_by_id
-- + Policy UPDATE sur places pour permettre l'ajout collaboratif d'époque
...
-- Allow authenticated users to update era_id and year_exact on any place
CREATE POLICY "users_can_set_era" ON public.places
